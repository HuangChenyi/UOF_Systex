...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <tr>
        <td>
     <asp:Label ID="Label3" runat="server" Text="金額最小值"></asp:Label>
 </td>
 <td>
     <telerik:RadNumericTextBox ID="rnumAmountMin" runat="server"
         MaxValue="100000" MinValue="0" Value="0"></telerik:RadNumericTextBox>
 </td>
        <td>
     <asp:Label ID="Label1" runat="server" Text="金額最大值"></asp:Label>
 </td>
 <td>
     <telerik:RadNumericTextBox ID="rnumAmountMax" runat="server"
         MaxValue="100000" MinValue="0" Value="0"></telerik:RadNumericTextBox>
 </td>
    </tr>
    <tr>
        <td>
              <asp:Label ID="Label4" runat="server" Text="品項填寫者"></asp:Label>
        </td>
        <td colspan="3">
