...
public partial class WKF_OptionalFields_optionField1 : WKF_FormManagement_VersionFieldUserControl_VersionFieldUC
{
    ...
    public override void SetField(Ede.Uof.WKF.Design.VersionField versionField)
    {
        ...
        if (fieldOptional != null)
        {
            ...
            CustomValidator1.ClientValidationFunction = "ValidateFunction_"+fieldOptional.FieldID;
